...
import logoSmall from '../assets/eggs_300.jpg';
import logoFull from '../assets/eggs_666.jpg';
    ...
    return (
        <div className="App">
            ...
            <header>
                ...
                {<img src={logoSmall} srcSet={logoFull + " 666w"} alt="Predictor 25-26" title="Predictor 25-26"/>}
                {/*login !== null && <div>
