...
import logoSmall from '../assets/havertz_300.jpg';
import logoFull from '../assets/havertz_666.jpg';
    ...
    return (
        <div className="App">
            ...
            <header>
                ...
                {<img src={logoSmall} srcSet={logoFull + " 666w"} alt="Predictor 26-27" title="Predictor 26-27"/>}
                {/*login !== null && <div>
